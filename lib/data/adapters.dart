...
Future<void> registerHiveAdapters() async {
  ...
  //    Hive.registerAdapter(TipoGargaloAdapter());
  //    print('[Hive Adapters] TipoGargaloAdapter registered.');
  // }
  ...
  //    Hive.registerAdapter(GargaloAdapter());
  //    print('[Hive Adapters] GargaloAdapter registered.');
  // }
